...
const TryModels = () => {
  ...
  const getdata = async () => {
    try {
      const res = await axios.get(`https://wide-eyed-wasp-gloves.cyclic.app/wrapper/findAllModel`);
  ...
  function getDetails(modelSlug) {
    return axios
      .get(`https://wide-eyed-wasp-gloves.cyclic.app/wrapper/findOneModel?name=${modelSlug}`)
